...
import zadania.shop_shoes.tools.Saver_to_file;
import zadania.shop_shoes.ui.Keeping;

public class App {
    private Scanner scanner =  new Scanner(System.in);
    private Keeping keeping = new Saver_to_file();
                        ...
                        switch (choice2) {
                            ...
                            case 3:
                                ...
                                if (input != 0){
                                    ...
                                    persons.get(check).getPurchase().add(shoeses.get(input-1));
